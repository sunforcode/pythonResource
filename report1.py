...
class HtmlReport(object):
    ...
    def report(self):
        case_res = self.report_dic["case_res"][0]
        print(case_res)
        responeDeatialString = ""
        responeDetailArray = case_res["responseDetial"]
        for responeDetialDic in  responeDetailArray:
            responeDeatialString += self.__case_detail.format(**responeDetialDic)
            pass

        print(responeDeatialString)
    ...
    res_list1 = [
        {
            ...
            "responseDetial":
                [
                    {"request": "a=1&b=2",
                     "response": "{'code':2020,'msg':'操作成2功'}"
                     },
                    {"request": "a=1&b=2",
                     "response": "{'code':2200,'msg':'操作成3功'}"
                     },
                    {"request": "a=1&b=2",
                     "response": "{'code':2100,'msg':'操作成4功'}"
                     }
                ]
        }
    ]

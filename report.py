...
class HtmlReport(object):
    ...
    <table width="95%" cellspacing="2" cellpadding="5" border="0" class="details" align="center">
    <tr valign="top">
    <th>所属项目</th><th>模块</th><th>用例描述</th><th>描述详情</th><th>测试人员</th><th>用例状态</th><th></th>
    </tr>{case_res}</table>
    <hr align="center" width="95%" size="1">
    </body>
    </html>
    ...
    __case_html = '''
    <tr valign="top" class="">
    <td>{project}</td><td align="center">{model}</td><td align="center">{detail}</td><td align="center">{caseSummary}</td><td align="center">{tester}</td><td align="center">{status}</td><td align="center"><a href="#" onclick="show('page_details_{case_id}');">查看接口详细</a></td>
    </tr>
    ...
    <tr>
    <th>请求URL</th><th>请求报文</th><th>返回报文</th>
    </tr>
    {detailList}
    </table>
    </div>
    ...
    __case_detail = '''
    <tr><td align="center" style="width :300px;word-break: break-all;"><span>{url}</span></td> <td align="center" style="width :300px;word-break: break-all;"><span>{request}</span></td><td align="center" style="width :300px;word-break: break-all;" ><span>{response}</span></td></tr>
    '''
    ...
    def report(self):
        ...
        for res in res_list:
            detialRes = ""
            for detial in res["responseDetial"]:
                detialRes += self.__case_detail.format(**detial)
                pass
            res["detailList"] = detialRes
